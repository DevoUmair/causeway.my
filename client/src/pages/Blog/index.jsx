...
function index() {
  ...
  return (
    <motion.div className='relative'>
        ...
        >
            <Nav page={pages?.BlogDetail?.name} />
            <SubBanner data={pages?.BlogDetail} isBig={false} />
            <SideBar page={pages?.BlogDetail?.name} />
            <BottomBar page={pages?.BlogDetail?.name} />
            <BlackBg />
            <BlogDetail />
            <Footer page={pages?.BlogDetail?.name} />
        </motion.div>
    </motion.div>
  )
}
