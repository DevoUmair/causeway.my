...
export function DatePickerDobSearch({
  ...
  const {setDobDateSearch ,  dobDateSearch} = useCausewayHqContext()
  ...
  const handleSelect = (selectedData: Date | undefined) => {
    if (selectedData) {
      ...
      setOpen(false)
      setDobDateSearch(convertDate(selectedData))
    }
  }
                  ...
                  <p className='font-medium  text-[14px]' >
                    {
                        ...
                        :
                        (
                            <span className='text-black' >   {dobDateSearch}</span>
                        )
                    }
                  </p>                    
              </div>
